...
polygon(x = c(RBA_upper_ci_adjusted_model[3], RBA_upper_ci_adjusted_model_D1[3]), c(5.85,6.15), border = 'blue')
text(3, 6, labels = paste0('(',min(round(RBA_lower_mean_adjusted_model_D1[3], 2),
                           ...
                           max(round(RBA_lower_mean_adjusted_model_D1[3], 2),
                               round(RBA_upper_mean_adjusted_model_D1[3],2)), ')', ' ',
                           '[',round(RBA_lower_ci_adjusted_model_D1[3], 2),'0',', ',
                           round(RBA_upper_ci_adjusted_model_D1[3],2),'0',']'), col = "blue", pos=4, cex=1)
...
polygon(x = c(RBA_upper_ci_adjusted_model[3], RBA_upper_ci_adjusted_model_D4[3]), c(5.85,6.15), border = 'blue')
...
polygon(x = c(RBA_upper_ci_adjusted_model[3], RBA_upper_ci_adjusted_model_D5[3]), c(5.85,6.15), border = 'blue')
...
text(3, 4, labels = paste0('(',min(round(RBA_lower_mean_adjusted_model_D5[4], 2),
                                   round(RBA_upper_mean_adjusted_model_D5[4],2)),'0','--',
